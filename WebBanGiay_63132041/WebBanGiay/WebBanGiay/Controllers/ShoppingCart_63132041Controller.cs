...
{
    public class ShoppingCart_63132041Controller : Controller
    {
        private WebBanGiay_63132041Entities1 db = new WebBanGiay_63132041Entities1();

        // GET: ShoppingCart_63132041
        // GET: ShoppingCart
        ...
        public ActionResult CheckDN()
        {
            ...
            if (Session["Cart"] == null || ((Cart)Session["Cart"]).Items.Count == 0)
            {
                ...
                return RedirectToAction("Index", "ShoppingCart_63132041");
            }
            else
            {
                return RedirectToAction("CheckOut", "ShoppingCart_63132041");
            }
        }
